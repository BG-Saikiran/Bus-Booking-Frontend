...
import { FaBus, FaChair, FaMapMarkerAlt, FaMoneyBillWave } from 'react-icons/fa';
...
api
  ...
  return (
    <div className="min-h-screen px-4 py-10 bg-gradient-to-br from-indigo-50 to-blue-100">
          ...
          {bookings.map((booking) => (
            <div
              ...
              className="bg-white/80 backdrop-blur-xl border border-white/50
                         rounded-2xl shadow-xl p-6 transition hover:scale-[1.01]"
            >
              {/* Header */}
              ...
              {/* Action */}
              <button
                className="mt-6 w-full sm:w-auto px-6 py-2
                           bg-indigo-600 hover:bg-indigo-700
                           text-white rounded-md font-medium transition"
                onClick={() =>
                  console.log(`Proceeding to payment for booking ${booking.id}`)
                }
              >
                Proceed to Payment
              </button>
