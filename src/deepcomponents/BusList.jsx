...
const BusList = ({ token }) => {
    ...
    return (
        <div className="max-w-7xl mx-auto px-3 sm:px-4 py-6 sm:py-8">
            <h1 className="text-2xl sm:text-3xl font-bold text-center mb-6 sm:mb-8 flex items-center justify-center gap-3">
                <FaBusAlt className="text-indigo-600" />
                Available Buses
            </h1>

            {/* Filters */}
            <div className="bg-white p-4 sm:p-5 rounded-xl shadow-md mb-6 sm:mb-8">
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
                    <div>
                        ...
                        <input
                            ...
                            className="w-full px-3 py-3 sm:py-2 border rounded-md focus:ring-2 focus:ring-indigo-500"
                            value={searchTerm}
                            onChange={(e) =>
                    ...
                    <div className="flex items-end">
                        <button
                            ...
                            className="w-full flex items-center justify-center gap-2 bg-gray-200 hover:bg-gray-300 font-semibold py-3 sm:py-2 rounded"
                        >
                            <MdClear />
                            Clear
                        </button>
            ...
            {filteredBuses.length === 0 ? (
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6">
                    {filteredBuses.map((bus) => (
                        <div
                            key={bus.id}
                            className="bg-white rounded-xl shadow hover:shadow-lg transition mx-1 sm:mx-0"
                        >
                            <div className="p-5 sm:p-6">
                                ...
                                <button
                                    ...
                                    className="mt-5 sm:mt-6 w-full bg-indigo-600 hover:bg-indigo-700 text-white py-3 sm:py-2 rounded-lg font-semibold"
                                >
                                    View Seats & Book
                                </button>
                            </div>
